...
class RoleUsersControllerTest < ActionController::TestCase
  ...
  test "should create role_user" do
    assert_difference('RoleUser.count') do
      post :create, role_user: { role_id: @role_user.role_id, user_id: @role_user.user_id, value: @role_user.value }
    end
  ...
  test "should update role_user" do
    patch :update, id: @role_user, role_user: { role_id: @role_user.role_id, user_id: @role_user.user_id, value: @role_user.value }
    assert_redirected_to role_user_path(assigns(:role_user))
  end
